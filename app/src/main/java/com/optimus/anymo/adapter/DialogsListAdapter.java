...
public class DialogsListAdapter extends RecyclerView.Adapter<DialogsListAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            message = (EmojiTextView) view.findViewById(R.id.message);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
                ...
                Glide.with(ctx)
                        ...
                        .listener(new RequestListener<Drawable>() {
                            ...
                            public boolean onResourceReady(Drawable resource, Object model, Target<Drawable> target, DataSource dataSource, boolean isFirstResource) {
                                ...
                                img.setVisibility(View.VISIBLE);
                                img.setColorFilter(Color.parseColor(item.getColor()));
                                return false;
                            }
                        })
                        .into(holder.image);
        ...
        holder.title.setText(item.getColorName() + " " + item.getIconName());
